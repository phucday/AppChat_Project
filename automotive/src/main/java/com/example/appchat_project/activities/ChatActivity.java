...
import com.example.appchat_project.databinding.ActivityChatBinding;
import com.example.appchat_project.model.ChatMessage;
import com.example.appchat_project.model.User;
import com.example.appchat_project.network.ApiClient;
import com.example.appchat_project.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void showToast(String messageBody){
    ...
    private void checkForConversion(){
        if(chatMessages.size() != 0){
            checkForConversionsRemotely(
                    preferenceManager.getString(Constants.KEY_USER_ID),
                    receiverUser.id);
            checkForConversionsRemotely(receiverUser.id,
                    preferenceManager.getString(Constants.KEY_USER_ID));
        }
    }

    private void checkForConversionsRemotely(String senderId,String receiverId){
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
